...
from ai_news_bot.constants import EMBEDDING_MODEL_ID, EMBEDDING_MODEL_MAX_INPUT_LENGTH
from ai_news_bot.base import SingletonMeta
...
class EmbeddingModelSingleton(metaclass=SingletonMeta):
    ...
    def __init__(
        ...
        max_input_length: int = EMBEDDING_MODEL_MAX_INPUT_LENGTH,
        device: str = "cuda:0",
